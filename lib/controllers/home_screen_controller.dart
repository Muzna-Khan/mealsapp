...
class HomeScreenController extends GetxController {
  ...
  RxList<Meal> favMeals = <Meal>[].obs;
  Rx<bool> toggleMealFavouriteStatus(Meal meal) {
    final mealsFav = favMeals.contains(meal);
    if (mealsFav) {
      favMeals.value = favMeals.where((m) => m.id != meal.id).toList();
      return false.obs;
    } else {
      favMeals.value = [...favMeals, meal];
      return true.obs;
    }
  }
}
